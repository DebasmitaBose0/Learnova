...
describe("badgeEngine calculations", () => {
  it("should run badge calculations without errors", () => {
    const results = runAllTests();
    expect(results).not.toBeNull();
    expect(typeof results.perfect.unlocked).toBe("boolean");
    expect(typeof results.earlyBird.unlocked).toBe("boolean");
    expect(typeof results.consistency.unlocked).toBe("boolean");
  });
});
